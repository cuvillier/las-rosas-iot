package com.lasrosas.iot.core.ingestor.sensors.impl.dragino;

import com.lasrosas.iot.core.ingestor.sensors.impl.dragino.DraginoLHT65Frame.UplinkTempHumRequest;
...
public class DraginoLHT65FrameDecoder {
	...
	public UplinkTempHumRequest decodeUplink(byte[] bytes) {
		var b0 = bytes[0];
		var statusBits = b0 & 0b11;
		var batteryStatus = BatteryStatus.getByCode(statusBits);
