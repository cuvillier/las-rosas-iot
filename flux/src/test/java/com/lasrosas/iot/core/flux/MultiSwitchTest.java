...
@EnableIntegration
@ContextConfiguration(classes = { DigitalTwinTestConfig.class})
@IntegrationComponentScan("com.lasrosas.iot.core")
public class MultiSwitchTest extends BaseDatabaseTest {
	public static Logger log = LoggerFactory.getLogger(MultiSwitchTest.class);
