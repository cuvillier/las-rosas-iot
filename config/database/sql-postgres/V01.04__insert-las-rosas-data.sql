...
INSERT INTO t_thg_gateway (gtw_natural_id, gtw_type_name) VALUES ('GatewayFincaLasRosas', 'RAK7249');

/* Insert Things */
INSERT INTO t_thg_thing (thg_fk_gtw_gateway,thg_fk_tty_type, thg_readable, thg_discriminator, lor_dev_eui)
	VALUES (
		(SELECT gtw_techid FROM t_thg_gateway WHERE gtw_natural_id='GatewayFincaLasRosas'),
...
INSERT INTO public.t_dtw_multiswitch(twi_techid, msw_expected_state, msw_state_when_connect)
VALUES (
